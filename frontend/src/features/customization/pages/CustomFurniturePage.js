...
import CustomFurnitureCard from '../components/CustomFurnitureCard';
...
const CustomFurniture = () => {
    ...
    const loadData = async () => {
        try {
            ...
            setCategories([
                { id: '', name: 'All Custom Furniture', count: customFurnitureProducts.length },
        ...
        <div className="catalog-page">
            <div className="container">
                <ModernPageHeader
                    ...
                    title={selectedCategoryName ? `${selectedCategoryName} Collection` : 'Custom Furniture'}
                ...
                <div className="catalog-header">
                    {selectedCategoryName && (
                        <div className="category-actions">
                            <Link to="/custom-furniture" className="clear-filter-btn">
                                View All Custom Furniture
                            </Link>
                        </div>
                    )}
                </div>
                    ...
                    <main className="catalog-main">
                        ...
                        <div className="products-grid">
                            {filteredProducts.map(product => (
                                <CustomFurnitureCard key={product.id} product={product} />
                            ))}
                        </div>
